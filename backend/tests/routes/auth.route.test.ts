...
const postgres = createPostgresTestManager({
  ...
  env: {
    database: ["AUTH_ROUTES_TEST_DB"],
    schema: ["AUTH_ROUTES_TEST_SCHEMA"],
    host: ["AUTH_ROUTES_TEST_DB_HOST"],
    port: ["AUTH_ROUTES_TEST_DB_PORT"],
    username: ["AUTH_ROUTES_TEST_DB_USER"],
    password: ["AUTH_ROUTES_TEST_DB_PASSWORD"],
  },
  defaults: {
