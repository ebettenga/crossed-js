...
import { View, Text, TextInput, TouchableOpacity, ActivityIndicator, Alert, Image, SafeAreaView, useColorScheme, KeyboardAvoidingView, Platform, ScrollView } from 'react-native';
